...
function preload() {
    ...
    game.load.spritesheet('Droid', 'TILED/character-sprite-sheets/sprite_monster/Bat/Bat/droid.png?v=1', 32, 32, 4);
...
function create() {
  ...
  //  enemy_bat.body.setSize(20, 32, 5, 16);
    ...
    //enemy_bat.anchor.set(0.5, 0.5);
    //enemy_bat.body.gravity.y = 1500;
    ...
    enemy_bat = game.add.sprite(32, 32, 'Droid');
